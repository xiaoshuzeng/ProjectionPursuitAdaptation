...
class ProjectionPursuitAdaptation:
    ...
    def __init__(self, tol_pce=2e-2, PPA_method=1, PPA_dim=None, main_verbose=True, name='Projection Pursuit Adaptation'):
        tol_pce_coeffs = 1e-4
        tol_adapt_dire = 1e-4
        self._name = name
            ...
            while True:
                ...
                while True:
                    ...
                    if (err_vec_a < self._tol_vec_a) and (err_c_k < self._tol_c_k):
                        ...
                        if self._main_verbose:
                            print('Single iteration exceed 50, exit from current iteration !!!')
                        break
                    else:
